...
void init_EdgeTag(py::module &m) {
    ...
    .def("setIndices", &EdgeTag::setIndices, "if abs of two index must equal 1, then it can return true,else return false\nInput: index1,index2\nReturn: true if success")
    .def("setTag", &EdgeTag::setTag, "it can modify the tag you set before\nInput: tag")
    .def("getIndex1", &EdgeTag::getIndex1, "it will return the value of index1 you set above\nReturn: index1")
    .def("getTag", &EdgeTag::getTag, "it will return the tag\nReturn: tag")
    .def("getIndex2", &EdgeTag::getIndex2, "it will return the value of index2 you set above\nReturn: index2")
    .def("getSpec", &EdgeTag::getSpec, "it can return the result ")
    .def("setOnSpec", &EdgeTag::setOnSpec, "using setOnSpec can set the new value\nInput: 'Index1:Index2:tag'")
